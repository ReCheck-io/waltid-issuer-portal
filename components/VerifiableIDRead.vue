...
<template>
  <div>
    <!-- VerifiableIdRead -->
    <div v-if="issuable.credentials[0].type == 'VerifiableId'">
        ...
        <div class="col-11">
          <div class="right-inner-addon input-container">
            ...
            <input
              ...
              v-model="
                issuable.credentials[0].credentialData.credentialSubject
                  .firstName
              " />
          </div>
        </div>
          ...
          <div class="right-inner-addon input-container">
            ...
            <input
              ...
              :class="
                enableEditor ? 'form-control border-primary' : 'form-control'
              "
              :placeholder="$t('CREDENTIAL.NAME_AND_FAMILY_NAME_AT_BIRTH')"
              aria-label="Name and family name at birth"
              v-model="
                issuable.credentials[0].credentialData.credentialSubject
        ...
        <div class="col-11">
          <div class="right-inner-addon input-container">
            ...
            <input
              ...
              aria-label="Gender"
              v-model="
                issuable.credentials[0].credentialData.credentialSubject.gender
              " />
          </div>
        </div>
      </div>
