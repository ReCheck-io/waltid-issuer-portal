      ...
      <section class="py-5 text-center container _onboarding">
        <div class="row py-lg-5">
          <div
            :class="
              this.wizardIndex === 0
                ? 'col-lg-6 text-center col-md-8 mx-auto px-2 py-4 border border-1 border-sm-0 border-secondary rounded _verify'
                : 'hide'
            ">
            <h2 class="fw-bolder">
              {{/*$t('ONBOARDING')*/}}
            ...
            <div class="mt-3">
              <p>
                This service verifies your domain, your email and ETH account<br />
                and issues a Gaia-X Participant Credential.
              </p>
            </div>
            <div class="mt-2">
              <p class="fw-bold text-primary mb-1">
                <span>Authenticated DID</span>
              </p>
              <div style="max-width: 100%">
                <span style="overflow-wrap: break-word">{{ this.did }}</span>
              </div>
            </div>
            <div class="mt-2">
              <div class="mb-3 d-flex justify-content-center">
                <div>
                  <a
                    @click="wizardNext"
                    class="d-flex justify-content-center align-items-center px-3 py-3 _input">
                    <div class="col-8 ps-3 text-start">
                      <span>Verify Domain</span>
                    </div>
                    <div class="col">
                      <i
                        v-if="this.domainVerified"
                        class="bi bi-check-circle-fill px-3 _checked text-primary"></i>
                  ...
                  <div
                    ...
                    <button
                      ...
                      class="btn _submit-btn py-3 px-4 text-center">
                      Issue Participant Credential
                    </button>
                    <button
                      v-else
                      class="btn _submit-btn-inactive py-3 px-4 text-center">
                      <img
                        v-if="issueBtnLoading"
                        src="loader.gif"
                        width="20px" /><span v-else
                        >Issue Participant Credential</span
                      >
                    </button>
                  </div>
                </div>
          ...
          <div
            :class="
              this.wizardIndex === 1
                ? 'col-lg-6 text-center col-md-8 mx-auto px-2 py-4 border border-1 border-secondary rounded _domain'
                : 'hide'
            ">
            <h2 class="fw-bolder">
              {{/*$t('ONBOARDING')*/}}
            ...
            <div class="mt-3">
              <p>
                Add the verification code as TXT record to the domains DNS
                records.
              </p>
            </div>
            <div class="mt-2">
              <div class="mb-3 d-flex justify-content-center">
                <div>
                  <form
                    form
                    action=""
                    @submit.prevent="getVerificationCode"
                    class="_form">
                    <div>
                      <input
                        type="text"
                      ...
                      <button
                        type="submit"
                        name="submit"
                        class="btn _submit-btn text-center">
                        <span v-if="this.txtVerificationLoading"
                          ><img
                            src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif"
                            alt="domain On Verification loading"
                            width="25px"
                            style="opacity: 0.5"
                        /></span>
                  ...
                  <textarea
                    ...
                    id="txt-verification"
                    :data="this.txtVerification"
                    v-model="txtVerification"></textarea
                  ><br />
                  <div v-if="this.success" class="d-flex justify-content-end">
                    <button @click="onCopy" class="btn _copy-btn text-center">
                  ...
                  <div class="_statue mt-3">
                    ...
                    <p v-if="this.coppied" class="text-secondary _fading">
                      TXT copied to clipboard
                    </p>
                    <p
                      v-if="this.domainVerified === false"
                      class="text-danger"
                      style="width: 250px; overflow-wrap: break-word">
                      Could not retrieve the domain verification code at
                      {{ this.domain }}
                    </p>
                    <span
                      v-if="this.domainVerified === true"
                      style="opacity: 0.7">
                      <img
                    ...
                    <p v-if="this.domainVerified === true" class="text-success">
...
export default {
  ...
  methods: {
    ...
    async getVerificationCode() {
      ...
      this.$axios
        .$post('/onboarding-api/domain/generateDomainVerificationCode', {
          domain: this.domain,
        })
        .then((res) => {
          console.log(res)
    ...
    verfiyDomain() {
      ...
      this.$axios
        .$post('/onboarding-api/domain/checkDomainVerificationCode', {
          domain: this.domain,
        })
        .then((res) => {
          console.log(res)
